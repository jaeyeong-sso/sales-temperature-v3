package com.salest.salestemperature.v3.service.model;

import java.io.Serializable;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

public class SalesLogRecord {
	...
	public String toString(){
		return String.format("[trDate]:%s, [trSeqNum]:%s, [trTime]:%s, [trProductCode]:%s, [trSalesProductNum]:%s, [trSalesAmount]:%s",
				trDate,trSeqNum,trTime,trProductCode,trSalesProductNum,trSalesAmount);
	}
}